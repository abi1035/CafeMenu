    ...
    <div className="float-wrapper">
      ...
      <table className="float-table">
        ...
        <tbody>
          ...
          <tr>
            <td colSpan={2} className="float-total-label">Float</td>
            <td><input value='50' readOnly /></td>
            <td colSpan={2} >Total Sales</td>
            <td><input value={grandTotal} readOnly /></td>
            <td colSpan={2} className="float-total-label">Difference</td>
            <td><input value={`${grandTotal-50}`} readOnly /></td>
          </tr>
        </tbody>
      </table>
    </div>
